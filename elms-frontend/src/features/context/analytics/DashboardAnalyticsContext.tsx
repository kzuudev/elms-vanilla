...
import type { TotalRemainingBalance, TotalPendingRequest, TotalUsedDays, EmployeeRecentActivityData, MonthlyConsumption, LeaveOverlap, TeamAvailability, TotalUsers} from "@/types/dashboard.ts";
...
type DashboardAnalyticsContext = {
    ...
    recentActivity: EmployeeRecentActivityData[] | null;
